...
| **Filters**   | Filters        | | | [`123, {}`](https://ubivar.com/docs/nodejs#update_filters) |  | [`{}`](https://ubivar.com/docs/nodejs#list_filters) | [See on github](https://github.com/ubivar/ubivar-node/blob/master/test/Resources/Filters/spec.js)| 
