...
|               | FlowBackup              | [`{}`](https://ubivar.com/docs/nodejs#create_flowbackup) | [`{}`](https://ubivar.com/docs/nodejs#retrieve_flowbackup) |  | [`{}`](https://ubivar.com/docs/nodejs#delete_flowbackup) | [`{}`](https://ubivar.com/docs/nodejs#list_flowbackup) | [See on github](https://github.com/ubivar/ubivar-node/blob/master/test/Resources/FlowBackup/spec.js)| 
