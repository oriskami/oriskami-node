...
| **Filters**   | Flows                   | [`{}`](https://ubivar.com/docs/nodejs#create_flow) | [`{}`](https://ubivar.com/docs/nodejs#retrieve_flow) |  | [`{}`](https://ubivar.com/docs/nodejs#delete_flow) | [`{}`](https://ubivar.com/docs/nodejs#list_flow) | [See on github](https://github.com/ubivar/ubivar-node/blob/master/test/Resources/Flows/spec.js)| 
